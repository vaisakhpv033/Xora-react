...
const Header = () => {
    const [isOpen, setIsOpen] = useState(false); // state for mobile menu modal
    ...
    return (
        <header className={clsx('fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4', isScrolled && 'bg-s2 shadow-lg py-2 backdrop-blur-[8px]')}>
